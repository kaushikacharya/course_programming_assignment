...
for i = 1:size(assignments,1)
    ...
    genotypeCopyVarOne = assignments(i,2);
    genotypeCopyVarTwo = assignments(i,3);
    
    genotype = allelesToGenotypes(genotypeCopyVarOne,genotypeCopyVarTwo);
    
    if phenotype == 1
        prob = alphaList(genotype);
    else
        prob = 1 - alphaList(genotype);
    end
